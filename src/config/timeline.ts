...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: [
      "Специализируюсь на сайтах для ",
      { text: "малого бизнеса", accent: "cyan" },
      ": лендинг, калькулятор, каталог, запись. Простая оплата — перевод или при получении, ",
      { text: "без сложных интеграций", accent: "gold" },
      ".",
    ],
    tag: "сейчас",
  },
